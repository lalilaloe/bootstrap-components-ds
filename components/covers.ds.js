export default {
  ...
  name: "covers",
  homepage:
    "https://www.patternfly.org/v4/C:dev\tailor\bootstrap-components-dssrcpingendocovers.html",
};
...
export const variants = [
  ...
  },
  {
    displayName: 2,
    picture: {
      src: "./pictures/covers/covers-2.png",
      width: 943,
      height: 589,
    },
    snippet: {
  ...
  },
  {
    displayName: 3,
    picture: {
      src: "./pictures/covers/covers-3.png",
      width: 943,
      height: 761,
    },
    snippet: {
      html: `<div class="py-5 text-center align-items-center d-flex pi-draggable" style="background-image: linear-gradient(to left bottom, rgba(189, 195, 199, .75), rgba(44, 62, 80, .75)); background-size: 100%;">
    <div class="container py-5">
      <div class="row">
  ...
  },
  {
    displayName: 4,
    picture: {
      src: "./pictures/covers/covers-4.png",
      width: 943,
      height: 750,
    },
    snippet: {
      html: `<div class="py-5 text-center text-white pi-draggable" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;">
    <div class="container">
      <div class="row">
  ...
  },
  {
    displayName: 5,
    picture: {
      src: "./pictures/covers/covers-5.png",
      width: 943,
      height: 657,
    },
    snippet: {
      html: `<div class="py-5 text-center text-white pi-draggable" style="position: relative; overflow: hidden;"> <video autoplay="" loop="" muted="" plays-inline="" style="position: absolute; right: 0; top: 0; min-width:100%; z-index: -100;">
  ...
  },
  {
    displayName: 6,
    picture: {
      src: "./pictures/covers/covers-6.png",
      width: 943,
      height: 558,
    },
    snippet: {
  ...
  },
  {
    displayName: 7,
    picture: {
      src: "./pictures/covers/covers-7.png",
      width: 943,
      height: 575,
    },
    snippet: {
      html: `<div class="py-5 text-center text-md-right pi-draggable" style="background-image: url(https://static.pingendo.com/cover-bubble-dark.svg);	background-position: right bottom;	background-size: cover;	background-repeat: repeat; background-attachment: fixed;">
    <div class="container">
      <div class="row">
  ...
  },
  {
    displayName: 8,
    picture: {
      src: "./pictures/covers/covers-8.png",
      width: 943,
      height: 509,
    },
    snippet: {
  ...
  },
  {
    displayName: 9,
    picture: {
      src: "./pictures/covers/covers-9.png",
      width: 943,
      height: 675,
    },
    snippet: {
  ...
  },
  {
    displayName: 10,
    picture: {
      src: "./pictures/covers/covers-10.png",
      width: 943,
      height: 599,
    },
    snippet: {
  ...
  },
  {
    displayName: 11,
    picture: {
      src: "./pictures/covers/covers-11.png",
      width: 943,
      height: 652,
    },
    snippet: {
      html: `<div class="py-5 align-items-center d-flex pi-draggable">
    <div class="container py-5">
      <div class="row">
  ...
  },
  {
    displayName: 12,
    picture: {
      src: "./pictures/covers/covers-12.png",
      width: 943,
      height: 499,
    },
    snippet: {
  ...
  },
  {
    displayName: 13,
    picture: {
      src: "./pictures/covers/covers-13.png",
      width: 943,
      height: 534,
    },
    snippet: {
